                                    ...
                                    <div className="bg-white rounded-lg overflow-hidden shadow-2xl">
                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="flex justify-between my-2">
                                                <button onClick={() => handleBuyNow(item.id)} className="inline-block px-4 py-2 text-white bg-[#365314] rounded-full hover:bg-blue-700"  >
                                                    Buy now
                                                </button>
                                                <button onClick={() => handleAddToCart(item.id)} className="inline-block px-3 py-2 text-white bg-[#701A75] rounded-full hover:bg-blue-700">
                                                    Add to cart
                                                </button>
